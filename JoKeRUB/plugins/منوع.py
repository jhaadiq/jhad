...
R = [
    ...
    "**-** مطور السورس **⪼ [𐇮 𓂐 𓆩الــسيد𓆪 𖠛🇷🇺 ](t.me/W_WlM)   \n"
    "**-** قناة السورس **⪼ [𐇮 جهادي ](t.me/sadam2s)   "
]
...
DevJoker = [6188100682]
#تضل تخمط من عمك جهاد ؟ الى اين يستمُر الفشل ياغُلام
...
async def Hussein(event):
    ...
    await event.edit(f'**ها هيَ الفيزات تم استخراجها من قبل سورس جهاد** \n@sadam2s:\n {response.text}')
...
async def Hussein(event):
    ...
    async for edited_response in event.client.iter_messages(bot_username, limit=1):
        if edited_response.id == response.id and edited_response.message != response.message:
            response = edited_response
    await event.edit(f'**ها هيَ المعلومات للفيزا تم استخراجها من قبل سورس جهاد** \n@sadam2s\n {response.text}')
...
async def Hussein(event):
    ...
    async for edited_response in event.client.iter_messages(bot_username, limit=1):
        if edited_response.id == response.id and edited_response.message != response.message:
            response = edited_response
    await event.edit(f'**ها هيَ البطاقة تم فحصها من قبل سورس جهاد** \n@sadam2s\n {response.text}')
