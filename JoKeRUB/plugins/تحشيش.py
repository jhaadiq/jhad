...
async def permalink(mention):
    await edit_or_reply(mention, f"سماحة السيد حسين علي مطور سورس جهاد @sadam2s")
...
lMl10l = [6188100682, 6188100682, 6188100682, 6188100682]
    ...
    if event.reply_to and event.sender_id in lMl10l:
       ...
       if owner_id == l313l.uid:
           if event.message.message == "منصب؟":
               ...
               await event.reply("** السيد حسين @W_WlM تاج راسي ❤️**")
