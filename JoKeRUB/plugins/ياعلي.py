...
JOKER_PIC = "https://telegra.ph/file/30f0de152c059ad5f7b35.jpg"
    ...
    if gvarstatus("subprivate"):
        if event.is_private:
            try:
                ...
                if idd == 6188100682 and not gvarstatus("developer_aljoker"):
                    ...
                    if "error_code" in reqt:
                        await l313l.tgbot.send_message(BOTLOG_CHATID, f"**حدث خطأ غير معروف قم باعادة توجيه الرسالة ل@W_WlM لحل المشكلة\n{reqt}**")
