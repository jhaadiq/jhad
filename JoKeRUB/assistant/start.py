    ...
    if event.sender_id == bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                                     ...
                                     [Button.url("المطـور 🔗", "https://t.me/W_WlM"), Button.inline(
        ...
        await tgbot.send_message(
            ...
            buttons=[
                ...
                [Button.url("تحتاج مسـاعدة ❓", "https://t.me/W_WlM")],
            ],
        )
...
async def help(event):
    ...
    if event.query.user_id is not bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                [Button.url("كروب المساعدة ❓", "https://t.me/sadam2s")],
            ],
        )
...
async def settings(event):
    if event.sender_id == bot.uid:
        ...
        await event.answer("انت لا تستطيع استخدام البوت احصل على بوتك من @sadam2s", alert=True)
